...
C {devices/lab_wire.sym} 560 -350 0 0 {name=p5 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 560 -180 0 0 {name=p6 sig_type=std_logic lab=VSS}
...
C {sky130_fd_pr/corner.sym} 60 -470 0 0 {name=CORNER only_toplevel=true corner=tt}
...
C {inv_pex.sym} 560 -260 0 0 {name=x1}
